<x-layouts.guest title="Reset Password">
    ...
    <form method="POST" action=
        ...
        <div class="mt-6">
            <button type="submit" class="w-full justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-bold text-blue-900 bg-yellow-400 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300">
